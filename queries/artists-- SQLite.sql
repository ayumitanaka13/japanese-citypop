...
VALUES (1, 1982, 'Eiichi Ohtaki', '大瀧 詠一', 'Kimi wa Tennen Shoku', '君は天然色', 'https://www.youtube.com/embed/dH9yLGoIxBw',
        E'The best of Japanese pop song! This one of the Ohtaki\s most popular song is included in the album "A long vacation".
...
VALUES (2, 1980, 'Tatsuro Yamashita', '山下 達郎', 'Ride On Time', 'ライド・オン・タイム', 'https://www.youtube.com/embed/1rdlHKioR6A',
        E'Tatsuro\s first big hit, a very popular and iconic city pop song! You can feel the uplifting feeling from the start of the song.
